  ...
  return (
    <div className="nav_container">
      ...
      <NavLink to="/explore" activeClassName="active" className="row">
        <p><i class="fa-solid fa-magnifying-glass"></i> Explore</p>
      </NavLink>
      ...
      <NavLink to="/message" activeClassName="active" className="row">
        <p><i class="fa-regular fa-envelope"></i> Message</p>
      </NavLink><NavLink to="/bookmarks" activeClassName="active" className="row">
        <p><i class="fa-regular fa-bookmark"></i> Bookmarks</p>
      </NavLink>
      ...
      <NavLink to="/more" activeClassName="active" className="row">
        <p> <i class="fa-solid fa-ellipsis"></i> More</p>
      </NavLink>
